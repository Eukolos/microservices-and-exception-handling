...
public class UserAppError {
    ...
    public UserAppError(final String apiVersion, final String code, final String message, final String domain,
    ...
    public static UserAppError fromDefaultAttributeMap(final String apiVersion,
